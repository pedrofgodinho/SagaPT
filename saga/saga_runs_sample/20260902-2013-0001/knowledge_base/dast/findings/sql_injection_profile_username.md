...
- **Endpoint:** `GET http://www.hackergram.com/profile?username=`
...
- **Severity:** High — the application returns raw database error messages to the user, confirming the parameter is concatenated into a SQL query without parameterization.